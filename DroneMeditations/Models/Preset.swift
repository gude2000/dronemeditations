        ...
        Preset("JG Low Intensity", .developerPatches,
               subtitle: "Quiet pad floor · gentle motion · low-amp meditative bed", [
                Voice(
                    ...
                    lfos: [
                        LfoState(shape: .sine, targets: [.pan], rateHz: 0.11, depth: 0.73),
                        LfoState(shape: .sine,
                                 targets: [.amplitude, .filterQ, .cutoff, .fmIndex, .fxMix],
                                 rateHz: 0.18, depth: 0.61),
                        nil,
                        LfoState(shape: .sampleAndHold, targets: [.pitch],
                                 rateHz: 0.14, depth: 1,
                                 rateSyncEnabled: true, rateDenomination: .thirtySecond)
                    ],
                ...
                Voice(
                    ...
                    lfos: [
                        ...
                        nil,
                        LfoState(shape: .sine, targets: [.cutoff, .filterQ],
                                 rateHz: 0.08, depth: 0.29),
                        LfoState(shape: .sine, targets: [.pitch, .fmIndex],
                                 rateHz: 0.47, depth: 0.39)
                    ],
                ...
                Voice(
                    ...
                    lfos: [
                        LfoState(shape: .sine, targets: [.pan, .fxMix],
                                 rateHz: 0.23, depth: 0.73),
                        LfoState(shape: .sine, targets: [.fmIndex],
                                 rateHz: 0.24, depth: 0.14),
                        LfoState(shape: .triangle, targets: [.cutoff],
                                 rateHz: 0.91, depth: 0.40),
                        LfoState(shape: .sampleAndHold, targets: [.pitch, .filterQ],
                                 rateHz: 0.49, depth: 1,
                                 rateSyncEnabled: true, rateDenomination: .sixteenth)
                    ],
                    drift: DriftVoiceConfig(pitchMode: .static,
                                            pitchAmount: 1.28, pitchPhase: 0.17,
                                            panMode: .glacial,
                                            panAmount: 0.81, panPhase: 0.85,
                                            quantizeToScale: true)
                )
               ]),
